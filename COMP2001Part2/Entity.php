...
<div class="w3-content" style="max-width:1400px">
    ...
    <header class="w3-container w3-center w3-padding-32">
        <h1><b>THE ENTITY</b></h1>
        <p>Welcome to the Entity Page for <span class="w3-tag">COMP2001 Part 2</span></p>
    </header>
    ...
    <div>
        ...
        <div>
            ...
            <div class="w3-card w3-margin">
                ...
                <button class="w3-button w3-black w3-disabled w3-padding-large w3-margin-bottom">Entity Page</button>
            </div>
